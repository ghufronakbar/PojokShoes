            ...
            .enqueue(object : Callback<List<KeranjangItem>> {
                override fun onResponse(call: Call<List<KeranjangItem>>, response: Response<List<KeranjangItem>>) {
                    if (response.isSuccessful) {
                        ...
                        Log.d("Keranjang", "onResponse: ${keranjangList.size} keranjang ditemukan")
                        Log.d("detailKeranjang", "onResponse: $activeKeranjang")
                        Log.d("pelangganId", "onResponse: $pelangganId")
